 ...
 *         'clients' => [
 *             'facebook' => [
 *                 '__class' => powerkernel\yiiauth\clients\FacebookApp::class,
...
class Facebook extends OAuth2
{
    ...
    /**
     * facebook manually login flow uri
     * @var string
     */
    public $redirect_uri = 'https://www.facebook.com/connect/login_success.html';
